...
function Shareknow() {
  ...
  return (
    <div className='bg-white text-black py-10 pb-12'>
      <div className="container mx-auto px-4 text-center leading-loose">
        <h2 className='text-xl md:text-2xl mt-4 leading-loose mr-auto text-center md:text-center'>GlowTogether</h2>
        <div className='container mx auto text-center md:text-center'>
          <h1 className='text-5xl md:text-5xl font-extrabold text-center'>
            <span className="text-balck">Share </span>
            <span className="text-orange-500">Knowledgo,</span>
          </h1>
        </div>
        <h1 className='text-5xl md:text-5xl font-extrabold leading-loose text-center'>Build New Bonds</h1>
        <div className='flex justify-center items-center mt-10'>
          <div className='relative relative w-full max-w-md'>
            <input type="text" placeholder="Find Skills to Share and Learn..." className="w-full pl-5 pr-2 py-2 border border-black-100 rounded-full text-black-800 bg-transparent shadow-md focus:outline-none focus:ring-2 focus:ring-black-500 focus:border-vlack-500" />
            <div className='absolute inset-y-0 right-0 left-84 flex items-center pr-3 pointer-events-none'>
