...
const TabBarRegister = () => {
      ...
      const fetchCategories = async () => {
        ...
        try {
          const response = await fetch(
            'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/moment/categories',
            {
              method: 'GET',
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/auth/register-step1',
        {
          method: 'POST',
  ...
  const verifyOtpAndRegister = async () => {
    ...
    try {
      const response = await fetch(
        'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/auth/register-step2',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const PersonalProfile = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/auth/register-step3',
        {
          method: 'POST',
          body: formData,
        }
  ...
  const ResendOtp = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/auth/resend-otp',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const completeRegistration = async () => {
    ...
    try {
      const response = await fetch(
        'https://db60-2403-6200-88a2-308d-1a2-2c41-9dc7-22a9.ngrok-free.app/auth/register-step4',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ email: storedEmail, interests }),
        }
      );
      const data = await response.json();
      if (!response.ok) {
          ...
          <div className="container mx-auto flex justify-center items-center p-1 flex-col translate-y-1 no-curve">
            ...
            <div className="text-[#333333] poppins-font p-1 pr-42 pl-53">
              ...
              <div className="p-2 pr-10">
                <div className="relative w-full max-w-2xl" style={{ width: '480px' }}>
                  <textarea
                    ...
                    className="text-[#333333] bg-[#FEF4F4] p-4 rounded-2xl w-full pr-20 pl-5 font-normal text-base item-[#BBBBBB]"
                    style={{ minHeight: '150px', verticalAlign: 'top' }}
                  />
                  <p className="absolute bottom-2 right-100 text-sm text-[#BBBBBB]">
            ...
            <div className="text-[#333333] poppins-font p-1 pl-14">
              ...
              <div className="p-2 pr-10 relative">
                <input
                  ...
                  className="text-[#BBBBBB] bg-[#FEF4F4] p-2 rounded-2xl w-full max-w-lg mx-auto flex flex-row pr-70 pl-10 font-normal text-base"
                />
                <span
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#AAAAAA] cursor-pointer pl-3"
                      ...
                      <img
                        src={
                          category.name === 'Language and Communication'
                            ...
                            ? Sciense
                            : lanGuage // Placeholder image สำหรับหมวดหมู่ที่ไม่มีรูป
                        }
                        alt={category.name}
